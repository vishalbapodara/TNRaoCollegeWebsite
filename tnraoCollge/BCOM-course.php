        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Bachelor of Commerce (B.Com) (Only For Girls)</h1> 
                        <nav aria-label="breadcrumb animated fadeIn">
                        <ol class="breadcrumb text-uppercase">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Courses</a></li>
                            <li class="breadcrumb-item text-body active" aria-current="page">Bachelor of Commerce (B.Com) (Only For Girls)</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-6 animated fadeIn">
                    <img class="img-fluid" src="img/bcom.jpg" alt="BCOM-course">
                </div>
            </div>
        </div>
        <!-- Header End -->
    ...
    <div class="container main">
        ...
        <div class="col-sm-12 aos-init aos-animate detail">
            <div class="course_detail">
                <span></span>
                <p></p>
                <h2>WHAT IS THE B.COM PROGRAM?</h2>
                <ul>
                    <li>
                        <span>B.Com is a 3 years of undergraduate program that covers all the fundamental knowledge of commerce field. It includes subjects like Accountancy, Taxation, Finance, Law. B.Com is an entry level course for many master degree courses. B.Com program provides a wide range of choices in the employment.</span>
                    </li>
                </ul>
           
                <span>
                <h2>T. N. RAO COLLEGE B.COM PROGRAM</h2>
            </span>
                <ul>
                    <li>
                        <span>B.Com program at T N Rao college offers an intellectually challenging curriculum that provides with a solid knowledge in business. With our program student will be able to solve difficult business problems.</span>
                    </li>
                  </ul>
            </div>
        </div>
