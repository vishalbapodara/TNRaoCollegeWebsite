        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Bachelor of Education (B.Ed.)</h1> 
                        <nav aria-label="breadcrumb animated fadeIn">
                        <ol class="breadcrumb text-uppercase">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Courses</a></li>
                            <li class="breadcrumb-item text-body active" aria-current="page">Bachelor of Education (B.Ed.)</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-6 animated fadeIn">
                    <img class="img-fluid" src="img/bed.jpeg" alt="BED-course">
                </div>
            </div>
        </div>
        <!-- Header End -->
    ...
    <div class="container main">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 box1" id="gray_box">
                        ...
                        <ul>
                            <li>
                            For category students it will be 45% & For general category it is 50%
                            </li>
                        </ul>
                    </div>
        ...
        <div class="col-sm-12 aos-init aos-animate detail">
            <div class="course_detail">
                <span></span>
                <p></p>
                <h2>WHAT IS THE B.ED. PROGRAM?</h2>
                <ul>
                    <li>
                        <span>B.Ed. is a 2 year graduation course with the focus on developing teaching skills in individuals in specialised stream. Students who are willing to make their career in teaching profession can opt for this course. Students can get opportunity in different educational institutions after compilation of B.Ed. degree.</span>
                    </li>
                </ul>
           
                <span>
                <h2>T. N. RAO COLLEGE B.ED. PROGRAM</h2>
            </span>
                <ul>
                    <li>
                        <span>B.Ed. program at T. N. Rao College is focused with the sole objective of covering multiple tasks performed by a teaching professional. Our course is designed in a such a way that it covers all the theoretical details that is required for any teaching professional. We also make our B.Ed. program course updated with the changes in curricular changes.</span>
                    </li>
                  </ul>
            </div>
        </div>
