...
<body>
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Master of Science - Microbiology (M.Sc.)</h1> 
                ...
                <div class="col-md-6 animated fadeIn">
                    <img class="img-fluid" src="img/msc-in-microbiology-in-rajkot.png" alt="">
                </div>
            </div>
        </div>
        <!-- Header End -->
    ...
    <div class="col-sm-12 aos-init aos-animate detail">
        <div class="course_detail">
            <span></span>
            <p></p>
            <h2>ARE YOU READY TO CREATE A DREAM FUTURE AND PURSUE THE M. SC. DEGREE IN MICROBIOLOGY?</h2>
            <ul>
                <li>
                    <span>Admission Open! M.Sc. Microbiology In Rajkot Why pursue Master Of Science - Microbiology in 
                        T. N. Rao College? Learn From PhD holders (Expert Teachers) Well 
                        Equipped Labs Safe Study Environment Economical Fee Structure Great Career Opportunities</span>
                </li>
            ...
            <ul>
                <li>
                    <span>Students from different parts of  India have learnt and made themselves future ready with our expert teachers.</span>
                </li>
                <li>
                    <span>Learn From PhD holders (Expert Teachers) and explore be the best version of yourself</span>
                </li>
              </ul>
        </div>
     </div>
