        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Master of Science (IT & CS) (M.Sc.)
</h1> 
                        <nav aria-label="breadcrumb animated fadeIn">
                        <ol class="breadcrumb text-uppercase">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Courses</a></li>
                            <li class="breadcrumb-item text-body active" aria-current="page">Master of Science (IT & CS) (M.Sc.)
</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-6 animated fadeIn">
                    <img class="img-fluid" src="img/mscit-scaled.jpg" alt="MSCIT-course">
                </div>
            </div>
        </div>
        <!-- Header End -->
    ...
    <div class="container main">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 box1" id="gray_box">
                        ...
                        <ul>
                            <li>
                            As per Saurashtra University Central Admission Board (SUCAB) Norms
                            </li>
                        </ul>
                    </div>
        ...
        <div class="col-sm-12 aos-init aos-animate detail">
            <div class="course_detail">
                <span></span>
                <p></p>
                <h2>WHAT IS THE  M.SC.(IT & CS) PROGRAM?</h2>
                <ul>
                    <li>
                        <span>M.Sc.(IT & CS) is 2 years postgraduate degree program in Information and Technology and Computer Application. This course will help IT graduates to enhance their knowledge related to computers and programming.</span>
                    </li>
                </ul>
           
                <span>
                <h2>T. N. RAO COLLEGE  M.SC.(IT & CS) PROGRAM</h2>
            </span>
                <ul>
                    <li>
                        <span>Our objective with M.Sc.(IT & CS) program is to convert our students into self-motivated, highly productive and technically competent professionals to meet with demands of the IT industry. This program will help graduates to prepare themselves to manage IT use, change and development.</span>
                    </li>
                  </ul>
            </div>
        </div>
