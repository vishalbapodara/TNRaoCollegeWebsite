  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1">Welcome back! Let’s continue <br> where we left off</span>
    ...
    <div class="forms">
        <div class="form-content">
          <div class="login-form">
            <div class="title"><i class="fa fa-user-circle"></i>Login</div>
          <form action="AdminLogin.php" method="POST">
            <div class="input-boxes">
              ...
              <div class="text sign-up-text">Don't have an account? <label for="">Contact Administrator</label></div>
            </div>
        </form>
      </div>
